...
var fightOrSkip = function (){
    //ask user if they'd like to tight or skip using function
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0){
            ...
            if (playerInfo.health> 0 && i < enemyInfo.length - 1) {
                var storeConfirm = window.confirm("The fight is over. visit the strore before the next round?")
...
var endGame = function() {
    ...
    if (playerInfo.money > highScore) {
        ...
        alert(playerInfo.name + " did not bear the high score " + highscore + ". Maybe next time!");
    }
